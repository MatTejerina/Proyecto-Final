  ...
  return (
    <>
          ...
          <Col md={9} className=" text-center mt-1">
            ...
            <Row className="justify-content-center">
              <Col md={3} className="mb-4">
                <Card className="h-100" as={Link} to='/plansPage'>
      ...
      <Container className="mt-4">
        ...
        <Row className="justify-content-center">
          <Col md={3} className="mb-4">
            <Card className="h-100" as={Link} to='/errorPage'>
          ...
          <Col md={3} className="mb-4">
            <Card className="h-100" as={Link} to='/errorPage'>
              ...
              <Card.Body>
                <Badge bg="info" className="mb-2">-10%</Badge>
                <Card.Title className='card-title' as={Link} to='/errorPage'>PURINA® PRO PLAN® ADULT</Card.Title>
                <Card.Text>
          ...
          <Col md={3} className="mb-4">
            <Card className="h-100" as={Link} to='/errorPage'>
              ...
              <Card.Body>
                <Badge bg="info" className="mb-2">-10%</Badge>
                <Card.Title className='card-title' as={Link} to='/errorPage'>Juguete para perros cuerdas </Card.Title>
                <Card.Text>
          ...
          <Col md={3} className="mb-4">
            <Card className="h-100" as={Link} to='/errorPage'>
              ...
              <Card.Body>
                <Badge bg="info" className="mb-2">-10%</Badge>
                <Card.Title className='card-title' as={Link} to='/errorPage'>Casa Rascador para Gatos </Card.Title>
                <Card.Text>
